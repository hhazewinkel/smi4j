...
public class ManApplScalarPrinter extends ManApplPrinter {
    ...
    public ManApplScalarPrinter(ManApplWriter output) {
        super(output);
    }
    ...
    public Object visit(AssignmentObject n, Object argu) {
        ...
        try {
            ...
            if (mtn.isScalar()) {
                ...
                out.println(" */");
                out.println("public class " + out.toClass(n.identifier) + " extends Scalar {");
                out.println("    private final String str_" + n.identifier + " = " +
                                ManApplMibTreeNode.getDottedObjectIdString(mtn) + ";");
                out.println("");
                out.println(1, out.toClass(n.identifier) + "(SnmpManager mgr) {");
                out.println(2, "super(mgr);");
                out.println(1, "}");
                out.println("");
                out.println(1, "/**");
                out.println(1, " * <PRE>");
                out.println(1, " * This function will retrieve the instance, " + n.identifier + ".");
                out.println(1, " * A ManagedInstance is as a result.");
                out.println(1, " * <PRE>");
                out.println(1, " */");
                out.println(1, "public ManagedInstance get() throws " + "Exception" + " {");
                out.println(2, "String emsg = \"\";");
                out.println(2, "try{");
                out.println(3, "return coreGet(str_" + n.identifier + ");");
                ...
                out.println(1, "/**");
                out.println(1, " * <PRE>");
                out.println(1, " * This function will retrieve the next instance of " + n.identifier + ".");
                out.println(1, " * A ManagedInstance is as a result.");
                out.println(1, " * <PRE>");
                out.println(1, " */");
                out.println(1, "public ManagedInstance getNext() throws " + "Exception" + " {");
                out.println(2, "String emsg = \"\";");
                out.println(2, "try{");
                out.println(3, "return coreGetNext(str_" + n.identifier + ");");
                out.println(2, "} catch (Exception e) { /* just catch any exception */");
                out.println(3, "/* need a generic module exception. */");
                out.println(2, "}");
                out.println(2, "throw new Exception(emsg);");
                out.println(1, "}");
                if (isWritable(((ObjectInfoObjectType)n.info).max_access)) {
                    out.println(1, "/**");
                    out.println(1, " * <PRE>");
                    out.println(1, " * This function will change (set) the instance.");
                    out.println(1, " * @param value The value to which the instance is set.");
                    out.println(1, " * </PRE>");
                    out.println(1, " */");
                    out.println(1, "public void set(int value) throws " + "Exception" + " {");
                    out.println(2, "String emsg = \"\";");
                    out.println(2, "try{");
                    out.println(3, "coreSet(str_" + n.identifier + ", value);");
                    out.println(2, "} catch (Exception e) { /* just catch any exception */");
                    out.println(3, "/* need a generic module exception. */");
                    out.println(2, "}");
                    out.println(2, "throw new Exception(emsg);");
                ...
                out.println(1, "/**");
                out.println(1, " * The main used for testing.");
                out.println(1, " */");
                out.println(1, "public static void main(String args[]) {");
                out.println(2, "try {");
                out.println(3, "MgrArguments.parseMgrArguments(\"java " + out.toClass(n.identifier) + "\", args);");
                out.println(3, "SnmpManager manager = new SnmpManager(MgrArguments.getRecipient(),");
                out.println(10, "MgrArguments.getRecipientPort(),");
                out.println(10, "new AuthCommunity(MgrArguments.getCommunity()),");
                out.println(10, "SnmpMessage.SNMP_VERSION_1);");
                out.println(3, out.toClass(n.identifier) + " mo = new " + out.toClass(n.identifier) + "(manager);");
                out.println(3, "System.out.println(\"-------- SNMP-GET --------------------------------\");");
                out.println(3, "ManagedInstance instance = mo.get();");
                out.println(3, "System.out.println(\"Instance \" + instance.name + \":\" + instance.value);");
                out.println(3, "System.out.println(\"-------- SNMP-GET-NEXT ---------------------------\");");
                out.println(3, "instance = mo.getNext();");
                out.println(3, "System.out.println(\"Instance \" + instance.name + \":\" + instance.value);");
                out.println(2, "} catch (Exception e) {");
                out.println(3, "System.out.println(e.getMessage());");
                out.println(3, "e.printStackTrace();");
                out.println(2, "}");
                out.println(1, "}");
                out.println("");
                out.println("");
